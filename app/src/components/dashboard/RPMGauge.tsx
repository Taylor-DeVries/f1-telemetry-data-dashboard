...
export default function RPMGauge({ 
  ...
  return (
    <div>
      ...
      {/* RPM Arc */}
      <div className="absolute inset-2 rounded-full border-8 border-transparent border-t-red-500 border-r-red-500"></div>
      ...
      <div className="absolute inset-0 text-xs text-red-500 font-mono">
        ...
        <div className="absolute" style={{ left: '25%', top: '70%' }}>3</div>
        <div className="absolute" style={{ left: '50%', top: '10%' }}>6</div>
        <div className="absolute" style={{ left: '75%', top: '70%' }}>9</div>
        <div className="absolute" style={{ left: '85%', top: '85%' }}>12</div>
      </div>
