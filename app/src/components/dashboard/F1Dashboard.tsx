      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            ...
            <div className="grid grid-cols-2 gap-4 h-full">
              ...
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-4">
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex justify-between text-xs text-gray-400">
                    <span>AVG SPEED</span>
                    <span className="text-white font-mono">{Math.round(getCurrentValue('speed') * 0.85)} km/h</span>
                  </div>
                  <div className="flex justify-between text-xs text-gray-400">
                    <span>MAX SPEED</span>
                    <span className="text-white font-mono">{telemetryData.metadata?.max_speed || 320} km/h</span>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-4">
                ...
                <div className="mt-4 space-y-2">
                  <div className="flex justify-between text-xs text-gray-400">
                    <span>AVG RPM</span>
                    <span className="text-white font-mono">{Math.round(getCurrentValue('rpm') * 0.9)}</span>
                  </div>
                  <div className="flex justify-between text-xs text-gray-400">
                    <span>MAX RPM</span>
                    <span className="text-white font-mono">{telemetryData.metadata?.max_rpm || 15000}</span>
                  </div>
                </div>
              </div>
            </div>
              ...
              {(manualSpeed !== null || manualRpm !== null) && (
                <div className="mt-3 pt-3 border-t border-gray-700">
                  <button
                    ...
                    className="w-full px-3 py-2 bg-cyan-600 hover:bg-cyan-700 text-white text-xs font-semibold rounded transition-colors"
                  >
                    Reset to Live Data
                  </button>
        ...
        <div className="mb-6">
          {selectedChannels.length > 0 ? (
            ...
            <div className="bg-gray-900 border border-gray-700 rounded-lg p-16 text-center">
              <div className="text-gray-600 mb-4">
                <svg className="w-12 h-12 mx-auto" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 19v-6a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2a2 2 0 002-2zm0 0V9a2 2 0 012-2h2a2 2 0 012 2v10m-6 0a2 2 0 002 2h2a2 2 0 002-2m0 0V5a2 2 0 012-2h2a2 2 0 012 2v14a2 2 0 01-2 2h-2a2 2 0 01-2-2z" />
                </svg>
              </div>
              <p className="text-gray-400 text-lg font-medium">No Channels Selected</p>
        ...
        <div className="grid grid-cols-12 gap-4 mb-6">
          ...
          <div className="col-span-12 lg:col-span-3">
            <div className="space-y-4 h-full">
              ...
              <div className="bg-gray-900 border border-gray-700 rounded-lg p-4 flex items-center justify-center">
