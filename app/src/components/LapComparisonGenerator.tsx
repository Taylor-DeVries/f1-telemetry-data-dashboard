...
export default function LapComparisonGenerator({ onDataGenerated, onClose }: LapComparisonGeneratorProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/70 backdrop-blur-sm flex items-center justify-center z-50 p-4">
      <div className="bg-gradient-to-br from-gray-800 to-gray-900 border border-gray-700 rounded-lg shadow-2xl max-w-4xl w-full max-h-[90vh] overflow-y-auto">
        {/* Header */}
        <div className="bg-gradient-to-r from-cyan-600 to-cyan-500 p-6 flex items-center justify-between">
          <div>
            ...
            <p className="text-cyan-100 text-sm mt-1">Create realistic F1 data for comparing two drivers</p>
          </div>
          <button
            onClick={onClose}
              ...
              <div className="space-y-4">
                <div>
                  ...
                  <div className="flex justify-between text-sm text-gray-400 mt-1">
                    <span>200</span>
                    <span className="text-red-400 font-bold">{lap1Params.max_speed}</span>
                    <span>400</span>
                  </div>
                </div>
                ...
                <div>
                  ...
                  <div className="flex justify-between text-sm text-gray-400 mt-1">
                    <span>1:00</span>
                    <span className="text-red-400 font-bold">{Math.floor(lap1Params.lap_time / 60)}:{(lap1Params.lap_time % 60).toString().padStart(2, '0')}</span>
                    <span>3:00</span>
                  </div>
                </div>
        ...
        <div className="bg-gray-800/50 p-6 flex justify-end space-x-4">
          ...
          <button
            ...
            disabled={loading}
            className="px-6 py-3 bg-gradient-to-r from-cyan-600 to-cyan-500 hover:from-cyan-700 hover:to-cyan-600 text-white font-bold rounded-lg transition-all transform hover:scale-105 shadow-lg disabled:opacity-50 disabled:cursor-not-allowed flex items-center"
          >
            {loading ? (
              <>
